...
public class TranslateActivity extends AppCompatActivity {
    ...
    public void translateText(View v) {
        ...
        String getURL = "http://gateway-a.watsonplatform.net/calls/text/TextGetTextSentiment?apikey=332172cbd4c2bc9ce2e8315648bc12b540c5ff6b&outputMode=json&text="+sourceText ;//The API service URL
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    try {
                        ...
                        final String score = convertedText.get("score").toString();
                        final String stype = convertedText.get("type").toString();
                        Log.d("okHttp", jsonResult.toString());
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                outputTextView.setText("Sentiment Type:  " + stype + "                 " + "          Score:   " + score);
                                System.out.println("Sentiment Type:" + stype + "  " + "Score:" + score);
                            }
                        });
